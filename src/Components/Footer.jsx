    ...
    style={{
      ...
      <div className='max-w-7xl mx-auto px-4'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
            <div>
                <h1 className='font-bold text-4xl mb-4'><span className='text-[#60B5FF]'>Trip</span>Buddy</h1>
            ...
            <div className='flex flex-col lg:items-center'>
                ...
                <ul className='space-y-2 text-sm'>
                    <li><a href="#" className='hover:text-[#60B5FF]'>Home</a></li>
                    <li><a href="#" className='hover:text-[#60B5FF]'>Destinations</a></li>
                    <li><a href="#" className='hover:text-[#60B5FF]'>Tours</a></li>
                    <li><a href="#" className='hover:text-[#60B5FF]'>About Us</a></li>
                    <li><a href="#" className='hover:text-[#60B5FF]'>Contact</a></li>
                </ul>
            </div>
            <div>
