  ...
  return (
    ...
    >
      ...
      <div className="text-white flex-col flex items-center justify-center px-4 lg:px-0 text-center max-w-7xl mx-auto z-20">
        ...
        <button className="bg-[#60B5FF] px-3 py-2 text-white rounded-md font-semibold  transition delay-110 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
          Start Planning
        </button>
      </div>
    </div>
