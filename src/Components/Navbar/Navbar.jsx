                    ...
                    <div className='flex items-center gap-5'>
                        <nav className='hidden md:flex gap-7'>
                            <ul className='flex items-center font-semibold text-white text-xl gap-7'>
                               <Link to='/'><li className='hover:text-[#60B5FF]'>Home</li></Link> 
                                <Link to='/tours'><li className='hover:text-[#60B5FF]'>Tours</li></Link>
                                <Link to='/gallery'><li className='hover:text-[#60B5FF]'>Gallery</li></Link>
                                <Link to='/about'><li className='hover:text-[#60B5FF]'>About Us</li></Link>
                                <Link to='/contact'><li className='hover:text-[#60B5FF]'>Contact</li></Link>
                            </ul>
                            <button className='bg-[#60B5FF] text-white px-4 py-1 rounded-md font-semibold'>Login in</button>
                        </nav>
                        <HiMenuAlt1 
                        onClick={toggleMenu} 
