...
>>>>>>> 94a45f4ab6f4734508d64e20334845abf4c8f212
                    </p>
                ...
                <div className="flex gap-5">
                        <Link to={`/edit-tour/${item._id}`}>
                          ...
                          <button className="px-5 py-3 rounded-lg text-white text-base font-semibold bg-gradient-to-r bg-[#f23866]  transition delay-110 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:from-indigo-5g00 hover:to-indigo-800" onClick={()=>Deletetour(item._id)}>
                            Delete
                          </button>
                      </div>
                </div>
